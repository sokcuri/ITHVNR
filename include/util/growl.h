...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD2: %x,%x", v, v2);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD3: %x,%x,%x", v, v2, v3);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD4: %x,%x,%x,%x", v, v2, v3, v4);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD5: %x,%x,%x,%x,%x", v, v2, v3, v4, v5);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD6: %x,%x,%x,%x,%x,%x", v, v2, v3, v4, v5, v6);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD7: %x,%x,%x,%x,%x,%x,%x", v, v2, v3, v4, v5, v6, v7);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD8: %x,%x,%x,%x,%x,%x,%x,%x", v, v2, v3, v4, v5, v6, v7, v8);
  GROWL_MSG(buf);
}
...
{
  WCHAR buf[100];
  _swprintf(buf, L"DWORD9: %x,%x,%x,%x,%x,%x,%x,%x,%x", v, v2, v3, v4, v5, v6, v7, v8, v9);
  GROWL_MSG(buf);
}
